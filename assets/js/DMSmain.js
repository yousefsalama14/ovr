...
$(document).ready(function () {
    ...
    $("#themeSelector").on("change", function () {
        ...
        $("body")
            .removeClass("DMSBlue DMSBlueBlue New")
    ...
    $("#themeColor").on("change", function () {
        if ($(this).val() == "theme-green") {
            $(":root").css(
                "--filter-img",
                "grayscale(100%) brightness(82%) sepia(9%) hue-rotate(46deg) saturate(3122%) contrast(85%)"
            );
        ...
        if ($(this).val() == "theme-blue") {
            $(":root").css(
                "--filter-img",
                "grayscale(100%) brightness(89%) sepia(10%) hue-rotate(180deg) saturate(4567%) contrast(91%)"
            );
        ...
        if ($(this).val() == "theme-yellow") {
            $(":root").css(
                "--filter-img",
                "grayscale(100%) brightness(94%) sepia(35%) hue-rotate(11deg) saturate(4027%) contrast(91%)"
            );
...
$(document).ready(function () {
    ...
    $(document).on("click", ".row-inline-add", function () {
        ...
        newRow
            ...
            .children()
            .first()
            .children(".fa-pencil-alt.row-inline-add")
...
function FilterDatatable(table) {
    var text =
        ' <i class="fas fa-search" onclick="showsearch(this)"></i><input type="text" class="form-control searchField"  onclick="disablesort(this)" />';
    var select =
        ' <i class="fas fa-search" onclick="showsearch(this)"></i><select class="form-control searchField" onclick="disablesort(this)"><option value=""></option></select>';
    var select2 =
        ' <i class="fas fa-search" onclick="showsearch(this)"></i><select class="form-control single-select searchField" onclick="disablesort(this)"><option value=""></option></select>';
